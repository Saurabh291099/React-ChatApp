...
const Chat = ({ user }) => {
    return (
        <>
            ...
            <div class="grid grid-rows-12 py-4 px-8 h-[100vh]">

                <div class="row-span-1 md:row-span-1">
                    <div className='flex flex-col gap-2'>
                        <div className='p-2 bg-[#F5F7FB] rounded-md'>
                            <div className='grid grid-cols-12 gap-2'>
                                <div class="col-span-1 flex justify-end items-center">
                                    <div className='flex justify-end items-center w-12 h-12 rounded-full overflow-hidden'>
                ...
                <div class="row-span-10 md:row-span-10 p-4">
                ...
                <div class="flex justify-center items-center p-2 gap-1 w-full row-span-1 md:row-span-1">
                    <button>
